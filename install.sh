...
#
# With options:
#   curl -fsSL https://raw.githubusercontent.com/cloonix/trx/main/install.sh | sh -s -- --version 0.2.1
#   curl -fsSL https://raw.githubusercontent.com/cloonix/trx/main/install.sh | sh -s -- --prefix ~/bin
#
# Or download and run:
#   curl -fsSL https://raw.githubusercontent.com/cloonix/trx/main/install.sh > install.sh
#   chmod +x install.sh
...
show_next_steps() {
    ...
    echo "  $ curl -fsSL https://raw.githubusercontent.com/cloonix/trx/main/install.sh | sh -s -- --uninstall"
    echo
}
